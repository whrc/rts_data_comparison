...
-   Figure out why new pred_to_poly conversion isn't working within `map()`
-   Fix duplication issue when I get polygon IDs.
...
```{r, echo = FALSE}
# json metadata
metadata <- drive_ls('https://drive.google.com/drive/folders/1TNRSVgLRhKbD-HVeC0HOslkFWzmhJija',
                             pattern = 'json$')
maxar_metadata <- metadata %>%
  pmap(
...
```{r, echo = FALSE}
# json metadata
metadata <- drive_ls('https://drive.google.com/drive/folders/1b1msmrdHmfSAFKb2fseg3CNb-JFJH6oj',
                             pattern = 'json$')
planet_metadata <- metadata %>%
  pmap(
...
```{r, echo = FALSE}
# json metadata
metadata <- drive_ls('https://drive.google.com/drive/folders/1RfSjwUPFZ2wmLuRt8-AA3XOKgZH2LcLQ',
                             pattern = 'json$')
