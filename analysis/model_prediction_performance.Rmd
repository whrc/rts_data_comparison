...
-   Figure out what to do with the disagreeing RTS outlines in the shapefile vs. the raster input data (4a, 4e, 4f, 67, 68, 89). It looks like the general outline was used in all tiles, regardless of whether or not the vector polygon from the shapefile was the active or general outline. Also figure out where the general outline used for the RTSLabel layer came from for 4a, 67, and 68.
-   ID 17 looks like the ground truth outline might be offset from all three imagery products
...
pred_ids <- map(maxar_preds, ~ get_rast_id(.x))
