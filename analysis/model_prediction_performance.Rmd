...
```{r, echo = FALSE}
maxar_rts_map <- avg_precision(maxar_rts_rec_pre)
planet_rts_map <- avg_precision(planet_rts_rec_pre)
sentinel_rts_map <- avg_precision(sentinel_rts_rec_pre)

maxar_bg_map <- avg_precision(maxar_bg_rec_pre)
planet_bg_map <- avg_precision(planet_bg_rec_pre)
sentinel_bg_map <- avg_precision(sentinel_bg_rec_pre)

maxar_map <- mean(maxar_rts_map, maxar_bg_map)
planet_map <- mean(planet_rts_map, planet_bg_map)
sentinel_map <- mean(sentinel_rts_map, sentinel_bg_map)
...
rm(maxar_rts_rec_pre, planet_rts_rec_pre, sentinel_rts_rec_pre,
   ...
   maxar_rts_map, planet_rts_map, sentinel_rts_map,
   maxar_bg_map, planet_bg_map, sentinel_bg_map,
   maxar_map, planet_map, sentinel_map)
```
