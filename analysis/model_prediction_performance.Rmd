...
pre_arosics_map <- ggplot() +
  ...
  scale_fill_manual(values = levels(sentinel_df$color.hex),
                    guide = FALSE) +
  new_scale_fill() +
  geom_raster(data = pre_arosics_df,
              aes(x = x, y = y, fill = color.hex)) +
  scale_fill_manual(values = levels(pre_arosics_df$color.hex),
                    guide = FALSE) +
  scale_x_continuous(name = 'Longitude',
                     limits = x_limits) +
  scale_y_continuous(name = "Latitude",
...
pre_mad_map <- ggplot() +
  ...
  scale_fill_manual(values = levels(sentinel_df$color.hex),
                    guide = FALSE) +
  new_scale_fill() +
  geom_raster(data = pre_mad_df,
              aes(x = x, y = y, fill = color.hex)) +
  scale_fill_manual(values = levels(pre_mad_df$color.hex),
                    guide = FALSE) +
  scale_x_continuous(name = 'Longitude',
                     limits = x_limits) +
  scale_y_continuous(name = "Latitude",
...
post_mad_map <- ggplot() +
  ...
  scale_fill_manual(values = levels(sentinel_df$color.hex),
                    guide = FALSE) +
  new_scale_fill() +
  geom_raster(data = post_mad_df,
              aes(x = x, y = y, fill = color.hex)) +
  scale_fill_manual(values = levels(post_mad_df$color.hex),
                    guide = FALSE) +
  scale_x_continuous(name = 'Longitude',
                     limits = x_limits) +
  scale_y_continuous(name = "Latitude",
...
```{r, plot.height = 5.75, plot.width = 6.5}
(
  (
    sentinel_map +
      theme(axis.title.x = element_blank(),
  ...
  theme(plot.tag.position = c(0, 1),
        plot.tag = element_text(size = 12, hjust = 0, vjust = -0.3))
```
...
hist_pre <- ggplot(pre_mad_df) +
  geom_density(aes(x = red),
               # color = 'red',
               fill = 'red',
               alpha = 0.33) +
  geom_density(aes(x = green),
               # color = 'red',
               fill = 'green',
               alpha = 0.33) +
  geom_density(aes(x = blue),
               # color = 'red',
               fill = 'blue',
               alpha = 0.33) +
...
hist_sent <- ggplot(sentinel_df) +
  geom_density(aes(x = B4),
               # color = 'red',
               fill = 'red',
               alpha = 0.33) +
  geom_density(aes(x = B3),
               # color = 'red',
               fill = 'green',
               alpha = 0.33) +
  geom_density(aes(x = B2),
               # color = 'red',
               fill = 'blue',
               alpha = 0.33) +
  scale_x_continuous(name = 'Surface Reflectance',
