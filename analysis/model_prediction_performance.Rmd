...
-   Adds size and shape histograms to another figure somehow
...
# maxar_single_rts_iou_predict <- my_nlsBootPredict(maxar_single_rts_iou_boot, newdata = newdata, interval = 'prediction')
...
maxar_single_rts_iou_ci <- newdata %>%
...
# planet_single_rts_iou_predict <- my_nlsBootPredict(planet_single_rts_iou_boot, newdata = newdata, interval = 'prediction')
...
planet_single_rts_iou_ci <- newdata %>%
...
# sentinel_single_rts_iou_predict <- my_nlsBootPredict(sentinel_single_rts_iou_boot, newdata = newdata, interval = 'prediction')
...
sentinel_single_rts_iou_ci <- newdata %>%
