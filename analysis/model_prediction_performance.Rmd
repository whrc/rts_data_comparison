...
```{r}
sentinel_water_files <- list.files(
  paste0(loc_dir, '/sentinel/water_mask'),
  full.names = TRUE
)

sentinel_water <- map(
  sentinel_water_files,
  ~ rast(.x) %>%
...
names(sentinel_water) <- ids

rm(sentinel_water_files, ids)
```
...
lum_delta_fig <- ggplot(
  ...
  geom_signif(
    data = zonal_stats_contrasts %>%
      filter(p_value <= 0.1 & variable == 'lum_mean' & rts_class == 'Delta'),
    aes(x = x_min, y = y, xend = x_max, yend = y,
        annotation = star_label, group = contrast),
    stat="identity",
    manual = TRUE,
...
r_delta_fig <- ggplot(
  ...
  geom_signif(
    data = zonal_stats_contrasts %>%
      filter(p_value <= 0.1 & variable == 'r_mean' & rts_class == 'Delta'),
    aes(x = x_min, y = y, xend = x_max, yend = y,
        annotation = star_label, group = contrast),
    stat="identity",
    manual = TRUE,
...
g_delta_fig <- ggplot(
  ...
  geom_signif(
    data = zonal_stats_contrasts %>%
      filter(p_value <= 0.1 & variable == 'g_mean' & rts_class == 'Delta'),
    aes(x = x_min, y = y, xend = x_max, yend = y,
        annotation = star_label, group = contrast),
    stat="identity",
    manual = TRUE,
...
b_delta_fig <- ggplot(
  ...
  geom_signif(
    data = zonal_stats_contrasts %>%
      filter(p_value <= 0.1 & variable == 'b_mean' & rts_class == 'Delta'),
    aes(x = x_min, y = y, xend = x_max, yend = y,
        annotation = star_label, group = contrast),
    stat="identity",
    manual = TRUE,
