...
```{r}
pre_mad <- rast('./data/planet/processing_examples/planet_processing_data_yg_val_regions_arosics_output_calibrated_files_0_20170715_062757_102d_3B_AnalyticMS_SR_harmonized_clip_arosics.tiff') %>%
  project('EPSG:3413')
post_mad <- rast('./data/planet/processing_examples/planet_processing_data_yg_val_regions_mad_output_calibrated_files_0_20170715_062757_102d_3B_AnalyticMS_SR_harmonized_clip_arosics_mad.tiff') %>%
  project('EPSG:3413')
sentinel <- rast('./data/planet/processing_examples/planet_processing_data_yg_val_regions_sentinel_data_Sentinel-2_YG_Validation_mosaic_bgrnir_Region_0_UTM42N.tiff') %>%
  project('EPSG:3413')
```

```{r}
plotRGB(pre_mad, r = 3, g = 2, b = 1, stretch = 'histogram')
plotRGB(post_mad, r = 3, g = 2, b = 1, stretch = 'histogram')
plotRGB(sentinel, r = 3, g = 2, b = 1, stretch = 'histogram')
```
