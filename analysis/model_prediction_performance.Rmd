...
-   Finalize RTS sample figure. Put IoU label in plot? Remove ID and IoU facet labels?
...
rts_pq <- polys %>%
  ...
  mutate(
    plotting_order = case_when(
      High == 2 & Low == 1 & imagery_low == 'Maxar' ~ 1,
      High == 2 & Low == 1 & imagery_low == 'Planet' ~ 2,
      High == 2 & Low == 1 & imagery_low == 'Sentinel-2' ~ 3,
      High == 3 ~ 4,
      High == 2 & Expected == 1 & imagery_expected == 'Maxar' ~ 5,
      High == 2 & Expected == 1 & imagery_expected == 'Planet' ~ 6,
      High == 2 & Expected == 1 & imagery_expected == 'Sentinel-2' ~ 7,
      Expected == 2 & High == 1 & imagery_high == 'Maxar' ~ 8,
      Expected == 2 & High == 1 & imagery_high == 'Planet' ~ 9,
      Expected == 2 & High == 1 & imagery_high == 'Sentinel-2' ~ 10,
      Expected == 3 ~ 11,
      Expected == 2 & Low == 1 & imagery_low == 'Maxar' ~ 12,
      Expected == 2 & Low == 1 & imagery_low == 'Planet' ~ 13,
      Expected == 2 & Low == 1 & imagery_low == 'Sentinel-2' ~ 14,
      Low == 2 & Expected == 1 & imagery_expected == 'Maxar' ~ 15,
      Low == 2 & Expected == 1 & imagery_expected == 'Planet' ~ 16,
      Low == 2 & Expected == 1 & imagery_expected == 'Sentinel-2' ~ 17,
      Low == 3 ~ 18,
      Low == 2 & High == 1 & imagery_high == 'Maxar' ~ 19,
      Low == 2 & High == 1 & imagery_high == 'Planet' ~ 20,
      Low == 2 & High == 1 & imagery_high == 'Sentinel-2' ~ 21,
      max_n == 1 & imagery_low == 'Maxar' ~ 22,
      max_n == 1 & imagery_low == 'Planet' ~ 23,
...
- Brighter RTS against a darker background are predicted better in the Planet model. Doesn't seem to be related to seasonality.
...
-   Poorly predicted RTS in the Planet and Sentinel models had higher NIR values within features. Both plants and soil reflect a lot of NIR... so what this means is a bit unclear.
...
iou_lm_output <- tibble(Imagery = 'Maxar',
                        Model = 'IoU ~ 1',
                        AIC = AIC(maxar_lm_smallest),
                        r2 = summary(maxar_lm_smallest)$r.squared) %>%
  bind_rows(tibble(Imagery = 'Maxar',
                   Model = 'IoU ~ Area',
  ...
  bind_rows(tibble(Imagery = 'Planet',
                   Model = 'IoU ~ 1',
...
There are two really large RTS that were poorly predicted in at least one of the Planet and Sentinel models:
...
-   Both the Planet and Sentinel images are really blurry relative to the Maxar in this area, making it visually impossible to delineate the RTS outside of the Maxar data.
...
-   Planet completely missed the feature, Maxar did well, Sentinel did ok (2)
-   The rest all had a prediction in each model, and each permutation was represented for which model had which prediction quality (3)
...
Selection of RTS Maps

```{r, fig.width = 6.5, fig.height = 9}
ggarrange(rts_maps[[which(pred_ids == "00000000000000000072")]] +
           theme(legend.position = 'none'),
         rts_maps[[which(pred_ids == "0000000000000000005d")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000032")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000006")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000046")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000010")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000012")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "00000000000000000016")]] +
           theme(legend.position = 'none',
                 strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         rts_maps[[which(pred_ids == "0000000000000000006c")]] +
           theme(strip.background.x = element_blank(),
                 strip.text.x = element_blank()),
         ncol = 1)
```
...
These images seem like they may be blurrier than the well predicted Planet RTS features and/or have less contrast.
