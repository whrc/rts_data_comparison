...
-   Try using magnitude of difference between RTS and BG for zonal stats, rather than normalizing with BG
...
|Imagery|Test IoU|Val IoU|
|:---:|:---:|:---:|
|Maxar|0.75|0.69|
|Planet|0.71|0.70|
|Sentinel-2|0.68|0.66|
...
iou <- polys %>%
  ...
  select(Imagery = imagery, `Val IoU` = mean_iou)
