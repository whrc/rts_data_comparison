...
-   Shapley analysis (figure out how to import Python models from Google Drive)
...
```{python}
# # maxar model
# with open('/content/drive/MyDrive/RTS_models/MODEL_V2_UNET3+_MAXAR/20220925-105508/params.json', 'r') as f:
#   PARAMS = json.load(f)
# 
...
# model_path = '/content/drive/MyDrive/RTS_models/MODEL_V2_UNET3+_MAXAR/20220925-105508/cp-0081-valiou0.727.ckpt'
# maxar_model.load_weights(model_path)
```
