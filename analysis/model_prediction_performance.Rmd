...
ggplot(polys %>%
  ...
  scale_y_continuous(name = 'RTS Area (raster ground truth)') +
  coord_fixed()
...
ggplot(polys %>%
  ...
  scale_x_continuous(name = 'RTS Shape (vector ground truth)',
                     limits = c(0, 1)) +
  scale_y_continuous(name = 'RTS Shape (raster ground truth)',
                     limits = c(0, 1)) +
...
ggplot(polys %>%
  ...
  scale_x_continuous(name = 'RTS Shape (vector ground truth)',
                     limits = c(0, 1)) +
  scale_y_continuous(name = 'RTS Shape (corrected to vector)',
                     limits = c(0, 1)) +
  coord_fixed(expand = FALSE)
